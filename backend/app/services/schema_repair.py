...
def repair_database_schema():
    ...
    repair_sql = [
        ...
        "ALTER TABLE support_agent_performance ADD COLUMN IF NOT EXISTS import_batch_id INTEGER;",
        "ALTER TABLE support_agent_performance ADD COLUMN IF NOT EXISTS range_start TIMESTAMP;",
        "ALTER TABLE support_agent_performance ADD COLUMN IF NOT EXISTS range_end TIMESTAMP;",
        "ALTER TABLE support_agent_performance ADD COLUMN IF NOT EXISTS granularity VARCHAR(20);",
        "ALTER TABLE support_agent_performance ADD COLUMN IF NOT EXISTS window_label VARCHAR(120);",
        ...
        "ALTER TABLE support_import_batches ADD COLUMN IF NOT EXISTS range_start TIMESTAMP;",
        "ALTER TABLE support_import_batches ADD COLUMN IF NOT EXISTS range_end TIMESTAMP;",
        "ALTER TABLE support_import_batches ADD COLUMN IF NOT EXISTS granularity VARCHAR(20);",
        "ALTER TABLE support_import_batches ADD COLUMN IF NOT EXISTS window_label VARCHAR(120);",
        ...
        "ALTER TABLE support_metric_snapshots ADD COLUMN IF NOT EXISTS import_batch_id INTEGER;",
        "ALTER TABLE support_metric_snapshots ADD COLUMN IF NOT EXISTS range_start TIMESTAMP;",
        "ALTER TABLE support_metric_snapshots ADD COLUMN IF NOT EXISTS range_end TIMESTAMP;",
        "ALTER TABLE support_metric_snapshots ADD COLUMN IF NOT EXISTS granularity VARCHAR(20);",
        "ALTER TABLE support_metric_snapshots ADD COLUMN IF NOT EXISTS window_label VARCHAR(120);",
