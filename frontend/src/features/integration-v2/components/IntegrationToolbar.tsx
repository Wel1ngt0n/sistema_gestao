...
import { IntegrationV2FilterState, IntegrationV2Filters, IntegrationV2SyncStatus } from '../types';
import { formatDate } from '../utils';

interface IntegrationToolbarProps {
    filters: IntegrationV2FilterState;
    options?: IntegrationV2Filters;
    viewMode: 'list' | 'kanban';
    filtersOpen: boolean;
    refreshing: boolean;
    syncing: boolean;
    syncStatus?: IntegrationV2SyncStatus;
    onFiltersChange: (filters: IntegrationV2FilterState) => void;
...
export default function IntegrationToolbar({
    ...
    const setFilter = (key: keyof IntegrationV2FilterState, value: string) => {
