                ...
                return (
                    ...
                    >
                        ...
                        <div aria-label="Monitor Card" className="p-5 pb-2">
                            ...
                            <h4 className="font-bold text-lg text-slate-800 dark:text-slate-100 leading-tight group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors mb-1">
                                {store.name}
                            </h4>
                        ...
                        <div aria-label="Monitor Card" className="px-5 py-2 flex-1 space-y-4">
                            ...
                            {/* Detailed Info Grid */}
                            <div aria-label="Monitor Card" className="grid grid-cols-2 gap-4 pt-2 border-t border-slate-100 dark:border-slate-700/50">
                                <div>
                                ...
                                <div>
                                    ...
                                    <div aria-label="Monitor Card" className="flex items-center gap-1.5">
                                        {store.implantador ? (
                                            <>
                                                <div aria-label="Monitor Card" className="w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-[9px] font-bold text-slate-600 dark:text-slate-300">
                        ...
                        <div aria-label="Monitor Card" className="px-5 pb-5 pt-2">
                            <div aria-label="Monitor Card" className="h-1.5 w-full bg-slate-100 dark:bg-slate-700/50 rounded-full overflow-hidden">
                                <div
