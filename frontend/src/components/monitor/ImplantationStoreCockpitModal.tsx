...
interface ImplantationStoreCockpitModalProps {
    isOpen: boolean;
    onClose: () => void;
    store: Store | null;
...
export default function ImplantationStoreCockpitModal({ isOpen, onClose, store, matrices, onSave, onDeepSync, isDeepSyncing }: ImplantationStoreCockpitModalProps) {
